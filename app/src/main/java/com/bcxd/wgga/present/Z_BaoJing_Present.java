 ...
 */
public class Z_BaoJing_Present extends BasePresent<Z_BaoJing_View> {

    public void alertListbyuidandpage(BaoJingBean baoJingBean, Context context) {
        Observable<ResponseBean<BaoJingInfo>> observable = RetrofitClient.builderRetrofit(context).create(APIService.class).listbyuidandpage(baoJingBean);

        // 此处请求接口
        addIOSubscription(observable, new ApiSubscriber(new ApiCallBack<BaoJingInfo>() {
            @Override
            public void onStart() {
                super.onStart();
                if (getView() != null) {
            ...
            @Override
            public void onSuccess(BaoJingInfo model) {
                if (getView() != null) {
                    getView().alertListbyuidandpageSuccess(model);
                }
            }
            ...
            public void onFailure(int code, String msg) {
                if (getView() != null) {
                    getView().onFailure(code, LogCode.GetCode("Z_BaoJing_Present_alertListbyuidandpage")+msg);
                }
            }
    ...
    public void refreshToken(Context context) {
        ...
        addIOSubscription(observable, new ApiSubscriber(new ApiCallBack<String>() {
            ...
            public void onFailure(int code, String msg) {
                if (getView() != null) {
                    getView().onFailure(code,LogCode.GetCode("Z_BaoJing_Present_refreshToken")+ msg);
                }
            }
