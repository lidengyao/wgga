 ...
 */
public class Z_JianCha_Present extends BasePresent<Z_JianCha_View> {
    ...
    public void searchbystatus(JianChaSearchBean jianChaSearchBean,Integer status, Context context) {
        ...
        addIOSubscription(observable, new ApiSubscriber(new ApiCallBack<JianChaInfo>() {
            ...
            public void onFailure(int code, String msg) {
                if (getView() != null) {
                    getView().onFailure(code,LogCode.GetCode("Z_JianCha_Present_searchbystatus")+ msg);
                }
            }
    ...
    public void refreshToken( Context context) {
        ...
        addIOSubscription(observable, new ApiSubscriber(new ApiCallBack<String>() {
            ...
            public void onFailure(int code, String msg) {
                if (getView() != null) {
                    getView().onFailure(code,LogCode.GetCode("Z_JianCha_Present_refreshToken")+ msg);
                }
            }
