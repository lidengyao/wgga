...
public class W_CheLiangJianKong_Activity extends MvpActivity<W_RenYuanBeiAnPresent> implements W_RenYuanBeiAnView {
    @Bind(R.id.SysNameIV)
    TextView SysName;
    ...
    protected int getLayoutId() {
        return R.layout.w_activity_cheliangjiankong;
    }
...
//        final ArrayList<Normal> normalArrayList = AnalyzeNormalXml.Analyze(this, this, "renyuanbeian_filter", filterLL, "0", ChildLL, DicListView);
        ...
        AddRL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mainIntent = new Intent(W_CheLiangJianKong_Activity.this, W_RenYuanBeiAn_Add_Activity.class);
    ...
    private void SetData(final ArrayList<ToxicCompanyMemberInfo> model) {
        ...
        W_RenYuanBeiAnAdapter w_renYuanBeiAnAdapter = new W_RenYuanBeiAnAdapter(this, model, R.layout.w_item_cheliangjiankong);
...
//        dataListView.setAdapter(w_dicAdapter);
        ...
        dataListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent mainIntent = new Intent(W_CheLiangJianKong_Activity.this, W_RenYuanBeiAn_Detail_Activity.class);
