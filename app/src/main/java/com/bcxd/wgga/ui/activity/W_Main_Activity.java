...
//                        toast(R.string.successfully);
    ...
    private void initPager() {
        ...
        fragments.add(new W_ShouYe_Fragment());
        fragments.add(new W_XiaoXi_Fragment());
        fragments.add(new W_Wo_Fragment());
...
//                maintitleTV.setText("我");
    ...
    public void getuserinfoSuccess(Z_UserInfo model) {
        if (model != null) {
            ...
            if (SpUtils.saveSettingNote(W_Main_Activity.this, DbKeyS.z_userinfo, z_userinfo)) {
//            if (AppContext.dbHelper.SetData(DbKeyS.z_userinfo, z_userinfo)) {
//                AppContext.dbHelper.SetData(DbKeyS.uid, model.getUid() + "");
                SpUtils.saveSettingNote(W_Main_Activity.this, DbKeyS.uid, model.getUid() + "");
...
//            TagAliasOperatorHelper.getInstance().handleAction(getApplicationContext(), sequence, tagAliasBean);
    ...
    public void projectlistSuccess(ArrayList<ProjectInfo> model) {
        ...
        if (SpUtils.saveSettingNote(W_Main_Activity.this, DbKeyS.ProjectInfo, gsonData)) {
...
//            AppContext.dbHelper.SetData(DbKeyS.gongdilist, gsonData);
            SpUtils.saveSettingNote(W_Main_Activity.this, DbKeyS.gongdilist, gsonData);
        } else {
//            AppContext.dbHelper.SetData(DbKeyS.gongdilist, "");
            SpUtils.saveSettingNote(W_Main_Activity.this, DbKeyS.gongdilist, "");
        }
