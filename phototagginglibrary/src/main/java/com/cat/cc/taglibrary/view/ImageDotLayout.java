...
public class ImageDotLayout extends FrameLayout implements View.OnClickListener, View.OnLongClickListener {
    ...
    private Drawable mIconDrawable = ContextCompat.getDrawable(getContext(), R.drawable.jiankong);
...
//        Glide.with(getContext()).load(url).apply(options).apply(RequestOptions.bitmapTransform(new RoundedCorners(1))).into(photoView);
